...
public DucerAction duceraction;
// input and expected output should come from DucerAction
DucerMeth2(DucerAction da, String principal){
duceraction = da;
...
// parses the 4 different strings: operator,patient
// forced logic, sampledef. in this version: parse by
// bits 0-8: length of this component. At end of this component, next bits 0-8
...
// returns 8 bits, adds any remaining bits to next sample
 for (int osl = 0;osl<length2;osl++){
  sampndiv = osl/sampleN;
 // get bit sampleN every osl times
  if (osl == (sampndiv * sampleN) ) { sample = sample +"1";}
...
int length1 = subject.length();
boolean retArray[] = new boolean[length1];
